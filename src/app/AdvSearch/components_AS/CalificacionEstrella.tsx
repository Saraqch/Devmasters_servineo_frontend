...
const CalificacionEstrella = () => {
  ...
  return (
    <div>
      ...
      {/* Contenedor principal con estilos consistentes y width ajustado */}
      <div className="bg-white rounded-lg border border-gray-300 p-4 w-fit">
        ...
        {finalRating !== null && (
          <div className="flex justify-center">
            <button
              onClick={handleReset}
              className="mt-4 flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors text-sm"
            >
              <RotateCcw size={18} />
